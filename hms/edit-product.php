...
$sql=mysqli_query($con,"Update product set proname='$proname', procat='$procat', proprice='$proprice', prodis='$prodis',proavg='$proavg', proquant='$proquant', prodesc='$prodesc', proimg='$proimg' where id='$eid'");
if($sql)
{
