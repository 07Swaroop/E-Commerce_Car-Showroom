...
$query=mysqli_query($con,"insert into bestseller(proname,procat,proprice,prodis,proavg,proquant,prodesc,proimg) values('$proname','$procat','$proprice','$prodis','$proavg','$proquant','$prodesc','$proimg')");
	if($query)
	{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Add Bestseller</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Bestseller</h5>
												</div>
...
?>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="proprice"  id="actualPrice" oninput="calculateDiscount()"  placeholder="Product Price" required>
							</div>
                            <div class="form-group">
								<input type="text" class="form-control" name="prodis"  id="discountedPrice" placeholder="Product Discount" required>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="proavg" placeholder="Product Average" required>
							</div>
							<div class="form-group">
