...
$query=mysqli_query($con,"insert into category(catname,catslug,catdes,catimg) values('$catname','$catslug','$catdes','$catimg')");
	if($query)
	{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<div class="form-group">
								<input type="text" class="form-control" name="catdes" placeholder="Category Description" required>
							</div>
<div class="form-group">
