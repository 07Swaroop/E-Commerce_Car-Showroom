					...
					<tbody>
						...
						while ($row = mysqli_fetch_array($sql)) { ?>
							...
							<tr>
								...
								<td><?php echo number_format($row['proprice'], 2); ?>Lakh</td>
								<td><?php echo number_format($row['prodis'], 2); ?>Lakh</td>
								<td><input type="number" class="form-control itemQty"
										value="<?php echo $row['quantity']; ?>" style="width:75px;"></td>

								<td class="text-right"><?php echo number_format($row['prodis'] * $row['quantity'], 2); ?>Lakh
								</td>
								<td class="text-right">
								...
								<input type="hidden" class="pdis" value="<?php echo $row['prodis']; ?>">

								<?php
								$discount_price = $row['prodis'];
						...
						<tr>
							...
							<td></td>
							<td>SubTotal</td>
							<td class="text-right"><?php echo number_format($grand_total, 2); ?>Lakh</td>
							<td></td>
						</tr>
						<tr>
							<td></td>
		...
		<div class="col mb-2">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 text-right">
					<a href="checkout.php?total=<?php echo $grand_total; ?>"
						class="btn btn-md btn-block btn-success text-uppercase <?= ($grand_total > 1) ? '' : 'disabled'; ?>">Checkout</a>
