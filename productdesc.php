...
<section class="h8">
  <div class="container">
    <div class="hcon1">
      ...
      <center> <b style="padding-top: 100px; margin-left:-860px ;">Honda Cars</b></center>
...
<div class="container back1  ">
  ...
  $sql = mysqli_query($con, "SELECT * FROM category WHERE id = ".$_GET['id']);
  ...
  if($sql) {
    ...
    ?>
      ...
      <div class="col colinfo2">
        ...
        <p> It features a 998cc engine, available with manual or automatic transmissions, and is a popular choice for city
          driving and commuting</p>
