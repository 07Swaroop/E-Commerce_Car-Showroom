...
if (isset($_POST['pcode']) && isset($_POST['pname']) && isset($_POST['pimage']) && isset($_POST['pprice'])) {
    ...
    if (!$check_code) {
        // Insert into cart
        $query = mysqli_query($con, "INSERT INTO cart (proname, proprice, prodis, proimg, quantity, total_price, product_code) 
            VALUES (
                '" . mysqli_real_escape_string($con, $name) . "', 
                '" . mysqli_real_escape_string($con, $price) . "', 
                '" . mysqli_real_escape_string($con, $prodis) . "', 
                '" . mysqli_real_escape_string($con, $image) . "', 
                '" . mysqli_real_escape_string($con, $qty) . "', 
                '" . mysqli_real_escape_string($con, ($price - $prodis) * $qty) . "', 
