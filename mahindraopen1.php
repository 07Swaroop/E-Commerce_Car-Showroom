...
?>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-7">
        <div class="d-flex align-items-center justify-content-between mb-2">
          <h2 class="car-title ctopen">Mahindra </h2>
          <span class="rating-badge">4.4 ★</span>
        </div>
        <p class="text-muted">The 4x4 model offers both engines with automatic transmission, while the RWD model has a manual transmission for diesel and automatic for petrol</p>
        <img src="./Images/thar.jpg" alt="Baleno Car" class="car-img rounded shadow-sm" height="500px "/>
      </div>
  
      <!-- Right Section -->
      <div class="col-md-5">
        <div class="price-box shadow-sm">
          <h5 class="mb-3" style="font-size: 25px; color: #6b1d1c; font-weight: 600;">Thar Price</h5>
          <p class="mb-1 text-muted">Thar price starts from <strong>₹ 10.70 Lakh</strong> and goes up</p>
          ...
          <h4 class="text-success">₹  8.14 Lakh <strike class="opens">₹  8.14 Lakh</strike></h4>
          <h4 class="offer" >Upto 10% OFF</h4>
          <small class="text-muted">Avg. Ex-Showroom Price</small>
  
          <div class="mt-4 border-top pt-3">
            <div class="d-flex justify-content-between align-items-center">
              <span><strong>Kia All Variants EMI</strong></span>
  ...
  <div class="container my-5">
      <h3 class="mb-4 fw-bold" style="color: #6b1d1c;">Similar Cars To Maruti Suzuki </h3>
    
      <div class="slider-container">
        <div class="slider-track">
          <!-- Card 1 -->
          <div class="car-card sim">
            <img src="images/scorpio.jpg" class="car-img carimg1" alt="Car 1">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra Scorpio</h5>
          ...
          <!-- Card 2 -->
          <div class="car-card">
            <img src="./Images/thar.jpg" class="car-img carimg1" alt="Car 2">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra Kia</h5>
          ...
          <!-- Card 3 -->
          <div class="car-card">
            <img src="./Images/marazzo.jpg" class="car-img carimg1" alt="Car 3">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra Marazzo</h5>
          ...
          <!-- Card 4 -->
          <div class="car-card">
            <img src="./Images/xev 9e.jpeg" class="car-img carimg1" alt="Car 4">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra xev 9e</h5>
          ...
          <div class="car-card">
            <img src="./Images/mahindra xuv700.jpg" class="car-img carimg1" alt="Car 1">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra xuv700</h5>
            <p>₹ 6.84 - 10.19 Lakh<br><small class="text-muted">Avg. Ex-Showroom price</small></p>
            <a href="Bookcar.php"> <button class="btn btn-outline-danger btn-sm">Book Now</button></a>
          ...
          <div class="car-card">
            <img src="./Images/mahindra-bolero-1.jpg" class="car-img carimg1" alt="Car 2">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Mahindra Bolero</h5>
            <p>₹ 6.90 - 10.00 Lakh<br><small class="text-muted">Avg. Ex-Showroom price</small></p>
            <a href="Bookcar.php"> <button class="btn btn-outline-danger btn-sm">Book Now </button></a>
