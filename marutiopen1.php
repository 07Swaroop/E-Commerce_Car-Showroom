    ...
    <div class="row g-4">
      ...
      <div class="col-md-7">
        <div class="d-flex align-items-center justify-content-between mb-2">
          <h2 class="car-title ctopen">Maruti Suzuki </h2>
          <span class="rating-badge">4.4 ★</span>
        </div>
        <p class="text-muted">The Maruti Baleno is a premium hatchback available in both petrol and CNG fuel options, offering manual and automatic transmissions</p>
        <img src="./Images/baleno.jpg" alt="Baleno Car" class="car-img rounded shadow-sm" height="500px "/>
      </div>
  
      <!-- Right Section -->
      <div class="col-md-5">
        <div class="price-box shadow-sm">
          <h5 class="mb-3" style="font-size: 25px; color: #6b1d1c; font-weight: 600;">Baleno Price</h5>
          <p class="mb-1 text-muted">Baleno price starts from <strong>₹ 6.70 Lakh</strong> and goes up</p>
          ...
          <h4 class="text-success">₹  9.92 Lakh <strike class="opens">₹  9.92 Lakh</strike></h4>
          <h4 class="offer" >Upto 10% OFF</h4>
          <small class="text-muted">Avg. Ex-Showroom Price</small>
  
          <div class="mt-4 border-top pt-3">
            <div class="d-flex justify-content-between align-items-center">
              <span><strong>Baleno All Variants EMI</strong></span>
      ...
      <div class="slider-container">
        <div class="slider-track">
          ...
          <div class="car-card sim">
            <img src="./Images/mcelerio.jpg" class="car-img carimg1" alt="Car 1">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Maruti Suzuki Mcelerio</h5>
          ...
          <!-- Card 2 -->
          <div class="car-card">
            <img src="./Images/mvitara.jpg" class="car-img carimg1" alt="Car 2">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Maruti Suzuki Mvitara</h5>
          ...
          <!-- Card 3 -->
          <div class="car-card">
            <img src="./Images/mfronx.jpeg" class="car-img carimg1" alt="Car 3">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Maruti Suzuki Mfronx</h5>
          ...
          <!-- Card 4 -->
          <div class="car-card">
            <img src="./Images/mwagon R.jpg" class="car-img carimg1" alt="Car 4">
            <h5 style="color: #6b1d1c; font-weight: 600; padding-top: 10px; font-size: 16px;">Maruti Suzuki Mwagon</h5>
